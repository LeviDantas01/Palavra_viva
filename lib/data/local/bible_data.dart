class BibleData {
  // Mapa Mestre: Nome do Livro -> Dados {abbrev, chapters}
  // Fonte: abibliadigital.com.br
  ...
  // Getters para facilitar o uso na tela
  static Map<String, int> get books {
    return {for (var item in _data) item['name'] as String: item['chapters'] as int};
  }

  static String getAbbreviation(String bookName) {
    final book = _data.firstWhere(
      (element) => element['name'] == bookName,
      orElse: () => {'abbrev': ''},
    );
    return book['abbrev'] as String;
  }
}